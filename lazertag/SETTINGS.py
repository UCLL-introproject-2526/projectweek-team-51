...
glevels_list = []
tlevels_list = []
seed = 0  # Default seed for level generation
...
'''Team settings'''
#Team-based gameplay settings
player_team = 'green'  # Player's team: 'green' or 'orange'
team_kills = {'green': 0, 'orange': 0}  # Track kills for each team
team_colors = {
...
my_id = random.randint(0, 999999) # Unique ID for this session
hit_events = [] # Queue for outgoing hit confirmations
remote_players = {} # Local cache of remote player objects
