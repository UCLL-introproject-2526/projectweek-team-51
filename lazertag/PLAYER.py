...
class Player:
    ...
    def __init__(self, pos):
        ...
        # Team assignment - player is assigned to the team set in SETTINGS
        self.team = SETTINGS.player_team
        self.color = SETTINGS.team_colors[self.team]  # Use team color instead of blue
    ...
    def control(self, canvas):
        ...
        #Change gun - LASER TAG: 1=melee, 2=laser rifle
                if key[pygame.K_1] and SETTINGS.inventory['melee']:
                    SETTINGS.next_gun = SETTINGS.inventory['melee']
                elif key[pygame.K_2] and SETTINGS.inventory['primary']:
                    SETTINGS.next_gun = SETTINGS.inventory['primary']
                elif key[pygame.K_3] and SETTINGS.inventory['secondary']:
